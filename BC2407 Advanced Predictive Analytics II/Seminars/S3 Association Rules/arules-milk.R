...
library(arules)
setwd("~/Desktop/Y2S2/BC2407/S3 Association Rules")
...
widedata2 <- widedata[,2:6] # Remove ID column as each row is considered one transaction.
...
?asummary(rules1)  # 24 rules satisfy min supp = 0.4, min conf = 0.3. Why so many?

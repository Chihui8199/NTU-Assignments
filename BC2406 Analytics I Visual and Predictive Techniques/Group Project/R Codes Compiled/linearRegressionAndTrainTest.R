...
data1 = data1[ ,`:=`(RowNumber = NULL, Surname = NULL, CustomerID = NULL, 
                     Retention = NULL, CLV = NULL, LastTransactionDate = NULL)]
View(data1)
...
library(ggplot2)
v2 <- ggplot(data1, aes(x = Gender, y = EmergingMarketFund, colour = Gender)) +
  geom_jitter(size = 5) +
  labs(x = 'Gender', y = 'EMF Investment Amount',
       title = "EmergingMarketFund against Gender", 

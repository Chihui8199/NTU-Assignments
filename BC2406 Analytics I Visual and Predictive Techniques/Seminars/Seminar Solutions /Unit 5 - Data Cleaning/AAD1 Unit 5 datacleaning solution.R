...
library(data.table)
setwd('D:/Dropbox/Schools/NBS/BC2406 Analytics 1/BC2406 AY18/5 Data Cleaning and Preparation')
...
custdata.dt <- fread('D:/Dropbox/Schools/NBS/BC2406 Analytics 1/BC2406 AY18/3 Data Exploration and Statistics/health_ins_cust.csv')
